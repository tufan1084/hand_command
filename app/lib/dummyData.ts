/** Dummy data for the HOI Command V1 demo dashboard. */

export const kpis = [
  { label: "Active Leads", value: "1,284", delta: "+12.4%", trend: "up" as const },
  { label: "Open Projects", value: "37", delta: "+3", trend: "up" as const },
  { label: "Monthly Revenue", value: "$184.2K", delta: "+8.1%", trend: "up" as const },
  { label: "Team Utilization", value: "87%", delta: "-1.2%", trend: "down" as const },
];
...
export const projects = [
  { id: 1, name: "Nova CRM Rollout",        client: "Aether Labs",      progress: 72, status: "On Track" },
  { id: 2, name: "Warehouse Vision System", client: "Nimbus Robotics",  progress: 41, status: "At Risk" },
  { id: 3, name: "Clinical Data Pipeline",  client: "Vega Biotech",     progress: 88, status: "On Track" },
  { id: 4, name: "Grid Forecasting",        client: "Helios Energy",    progress: 55, status: "On Track" },
  { id: 5, name: "Fraud Detection v2",      client: "Orbital Finance",  progress: 23, status: "Planning" },
];
...
export const team = [
  ...
  { id: 2, name: "Karan Mehta",    role: "Solutions Architect", load: 64, status: "active"  },
  { id: 3, name: "Anita Rao",      role: "Data Lead",           load: 91, status: "active"  },
